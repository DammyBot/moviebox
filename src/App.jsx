...
function App() {
  ...
  //URL for fetching movies by genre in the Genre page
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/genre" element={<SelectGenre genre={genre} setURL={setGenreURL} page={page} />} />

        <Route path="/moviegenre" element={<Genre genreURL={genreURL} setGenreURL={setGenreURL} genreResult={genreResult} setGenreResult={setGenreResult} />} />
